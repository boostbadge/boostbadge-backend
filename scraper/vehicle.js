...
async function createPhotos(url) {
  if (url != null) {
    try {
      const result = await cloudinary.v2.uploader.upload(url, {
        upload_preset: `BB Vehicle Photo`,
      });
